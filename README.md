...
一个基于 [sing-box](https://github.com/SagerNet/sing-box) 的代理管理工具
...
```bash
# 安装
sudo dpkg -i singboxa_1.0.2_amd64.deb
...
```bash
# 服务管理
sudo systemctl start singboxA    # 启动管理服务
sudo systemctl stop singboxA     # 停止管理服务
sudo systemctl restart singboxA  # 重启管理服务
sudo systemctl status singboxA   # 查看状态
